	...
	<div id="summary-area" class="d-flex p-2 bd-highlight">
		...
		<div>
			...
			<a href="https://wanwannogame.web.app/wanwannogame/index.html">
				<img src="../../laravelapp/public/images/game150.PNG" alt="わんわんのゲーム" />
			</a>
		</div>
	</div>
	<div id="login-area">
		<div id="login-fome-area" class="float-right">
			<img class="img-fluid" src="../../laravelapp/public/images/loginhome300.PNG" alt="ログインの家"	/>
				<form id="login-form" class="text-center container">
					<div id="login-input">
						<input id="login-un" type="text" align="center"	placeholder="UserId" />
						<br />
						<input id="login-pass" type="password" align="center" placeholder="Password" />
						<br />
						<a id="login-submit" align="center" href="index.html">
							<img class="img-fluid" src="../../laravelapp/public/images/login100.PNG" alt="ログイン" />
						</a>
						<br />
						<br />
						<a href="userRegistration.html">
							<img class="img-fluid" src="../../laravelapp/public/images/shinkitoroku150.PNG" alt="しんきとうろく" />
								</a>
							</div>
						</form>
					</div>
